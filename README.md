...
| `general.move_cursor_on_focus`           | Moves the mouse cursor to the center of the focused window (when using `focus`/`move`/`insert`/`moveinsert` actions) | `true`, `false`                                                                                                          | `false`                            |
