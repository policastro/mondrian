...
| `modules.overlays.active.border_radius`   | Border radius of the overlay                                                | 0 - 100                                                                           | 15                                 |
...
| `modules.overlays.inactive.border_radius` | Border radius of the overlay                                                | 0 - 100                                                                           | 15                                 |
